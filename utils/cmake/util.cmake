...
function(FORM_SHELL_COMMAND device process_obj output_command)
    if("${${process_obj}.command}" STRGREATER "")
        ...
        set(SHELL_PROCESS_COMMAND ${${process_obj}})
        set(SHELL_PROCESS_DEPENDS "")
    endif()
    ...
    string(REPLACE "<OUTPUT_HEX_LOCATION>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR}/${device.device}.hex  CODAL_CONCAT_REPLACE_COMMAND ${SHELL_PROCESS_COMMAND})
    string(REPLACE "<OUTPUT_HEX_DESTINATION>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})
    string(REPLACE "<OUTPUT_HEX_NAME>" ${device.device} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})

    string(REPLACE "<OUTPUT_BIN_LOCATION>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR}/${device.device}.bin  CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})
    string(REPLACE "<OUTPUT_BIN_DESTINATION>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})
    string(REPLACE "<OUTPUT_BIN_NAME>" ${device.device}.bin CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})

    string(REPLACE "<OUTPUT_ELF_LOCATION>" ${PROJECT_SOURCE_DIR}/build/${device.device} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})
    string(REPLACE "<OUTPUT_ELF_DESTINATION>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})
    string(REPLACE "<OUTPUT_ELF_NAME>" ${device.device} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})

    string(REPLACE "<CODAL_APP_OUTPUT_DIR>" ${PROJECT_SOURCE_DIR}/${CODAL_APP_OUTPUT_DIR} CODAL_CONCAT_REPLACE_COMMAND ${CODAL_CONCAT_REPLACE_COMMAND})

...
This repository provides the necessary tooling to compile a C/C++ CODAL program for the micro:bit v2 and generates a HEX file that can be downloaded to the device.
